 ...
 // it is used when any reciver id or sender id rende the update the chat history 
  ...
  async function FetchHistory() {
    try {
      ...
      const Resp = await axios.get(`https://chat-backend-gray-six.vercel.app/${senderId}/${receiverId}`);
  ...
  async function sendMessage(e) {
    ...
    try {
      const MessSend = await axios.post("https://chat-backend-gray-six.vercel.app/ChatMess", {senderId,senderName,receiverId,receiverName,message: Mess});
      SetMess("");
